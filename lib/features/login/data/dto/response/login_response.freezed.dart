...
// @JsonKey(name: "status")
  String get status; // @JsonKey(name: "data")
  LoginData get data;
...
abstract mixin class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, LoginData data});
...
extension LoginResponsePatterns on LoginResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String status, LoginData data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({required this.status, required this.data});
...
// @JsonKey(name: "accessToken")
  String get accessToken; // @JsonKey(name: "refreshToken")
