...
extension SignUpStatePatterns on SignUpState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(SignUpModel? signUpModel, bool? isSignUpSuccess,
            bool isLoading, String? error, Map<String, dynamic> signUpform)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SignUpState() when $default != null:
        return $default(_that.signUpModel, _that.isSignUpSuccess,
            _that.isLoading, _that.error, _that.signUpform);
      case _:
        return orElse();
    }
  }
