...
class _SignUpResponse implements SignUpResponse {
  const _SignUpResponse({required this.status, required this.data});
...
abstract mixin class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String email, String role, String authType});
}
...
extension UserPatterns on User {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _User() when $default != null:
        return $default(
            _that.id, _that.name, _that.email, _that.role, _that.authType);
      case _:
        return orElse();
    }
  }
