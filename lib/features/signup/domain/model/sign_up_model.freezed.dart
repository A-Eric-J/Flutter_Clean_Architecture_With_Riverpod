...
extension SignUpModelPatterns on SignUpModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, String name, bool isSignUpSuccess)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SignUpModel() when $default != null:
        return $default(_that.email, _that.name, _that.isSignUpSuccess);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String email, String name, bool isSignUpSuccess) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _SignUpModel():
